...
$mail->Body    = "Hii ".$_POST['fullname'].", <br/>Thank you for subscribing to FreshEye.<br/>
We are assessing your domain ".$_POST['domainname']."
<br/>someone from our team would get back to you soon";
$mail->AltBody = "Hii ".$_POST['fullname'].", <br/>Thank you for subscribing to FreshEye.<br/>
We are assessing your domain ".$_POST['domainname']."
<br/>someone from our team would get back to you soon";
